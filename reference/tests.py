...
.table-secondary {
  ...
  --tblr-table-border-color: #ced1d7;
...
.table-light {
  ...
  --tblr-table-border-color: #e0e3e7;
...
.table-dark {
  ...
  --tblr-table-border-color: #2e3947;
...
textarea.form-control.is-valid {
  padding-right: calc(1.4285714286em + 1.125rem);
  background-position: top calc(.3571428572em + .28125rem) right calc(.3571428572em + .28125rem)
}
...
.was-validated .form-select:valid:not([multiple])[size="1"] {
  ...
  background-size: 16px 12px, calc(.7142857143em + .5625rem) calc(.7142857143em + .5625rem)
}
...
.link-primary:focus,
.link-primary:hover {
  color: RGBA(26, 86, 157, var(--tblr-link-opacity, 1)) !important;
  -webkit-text-decoration-color: RGBA(26, 86, 157, var(--tblr-link-underline-opacity, 1)) !important;
  text-decoration-color: RGBA(26, 86, 157, var(--tblr-link-underline-opacity, 1)) !important
}
...
.border {
  border: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}

.border-wide {
  border: 2px var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}
...
.border-top {
  border-top: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}

.border-top-wide {
  border-top: 2px var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}
...
.border-end {
  border-right: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}

.border-end-wide {
  border-right: 2px var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}
...
.border-bottom {
  border-bottom: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}

.border-bottom-wide {
  border-bottom: 2px var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}
...
.border-start {
  border-left: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}

.border-start-wide {
  border-left: 2px var(--tblr-border-style) rgba(4, 32, 69, .1) !important
}
...
.offcanvas-header {
  border-bottom: var(--tblr-border-width) var(--tblr-border-style) rgba(4, 32, 69, .1)
}
...
.bg-white-overlay {
  color: #fff;
  background-color: rgba(246, 248, 251, .24)
}
